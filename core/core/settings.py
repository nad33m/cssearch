...
SECRET_KEY = 'django-insecure-v4w7k(!ol30^8@1wa!yxzav8y_bvbz8yih*%r+n$x^b$nrd!6$'
...
if not DEBUG:    # Tell Django to copy static assets into a path called `staticfiles` (this is specific to Render)
    ...
    # and renames the files with unique names for each version to support long-term cach
